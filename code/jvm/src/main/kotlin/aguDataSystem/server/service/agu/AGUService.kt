...
class AGUService(
     ...
     */
    fun getPredictionTemperatureMeasures(cui: String, days: Int): GetTemperatureMeasuresResult {
        ...
        return transactionManager.run {
            ...
            val levels = it.temperatureRepository.getPredictionTemperatureMeasures(provider.id, days)
